...
const ExploreComponent = () => {
    return(`
            <div class="wd-search-area mb-2">
                <div class="wd-search-left">
                    <i class="fa fa-search wd-search-icon"></i>
                    <input type="text" placeholder="Search twitter">
                </div>

                <div>
                    <i class="fa fa-cog fa-2x wd-cog-icon"></i>
                </div>
            </div>
